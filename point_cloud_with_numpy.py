...
if __name__ == "__main__":
    ...
    xyz1 = np.load('cloudABxyz.npy')
    # xyz2 = np.load('cloudABxyz.npy')
    # xyz3 = 
    # xyz = [np.load('cloudABxyz.npy')]
    # Pass xyz to Open3D.o3d.geometry.PointCloud and visualize.
    pcd = o3d.geometry.PointCloud()
    pcd.points = o3d.utility.Vector3dVector(xyz1)
    colors = np.load('cloudABrgb.npy')
    pcd.colors = o3d.utility.Vector3dVector(colors[:len(xyz1), :3])
